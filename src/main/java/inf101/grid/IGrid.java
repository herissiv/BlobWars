...
public interface IGrid<T> extends Iterable<T> {
	...
	/**
	 * Shall check every neighbour with max distance 2, and check if that location is an element 
	 * Be aware of IndexOutOfBoundsExeption 
	 * @param to
	 * @return
	 */
	List<Location> neighbourLocations(Location to, T elem);
