...
public class GameGUI extends Input implements ActionListener, Graphics {
	...
	/**
	 * Venter på at 2 game panels er valgt (tilsvarer deres locations) 
	 * også returnerer et BlobWarsLocations(from,to) (den rekkefølgen)
	 * @return BlobWarsLocations
	 */
	@Override
	public BlobWarsLocations getBlobWarsLocations() {
		List<Location> selectedPanels = getSelectedPanels(2);
		BlobWarsLocations blobLoc = new BlobWarsLocations(selectedPanels.get(0), selectedPanels.get(1));
		return blobLoc;
	}
